# -*- coding: utf-8 -*-
"""
Created on Sat Dec 30 16:04:22 2017
...
for i in range(101):
    H1.append(-10 + 0.2 * i)
    M1.append( Mag1(5,H1[-1]))
for j in range(101):
    H2.append(10-0.2 * j)
    M2.append((Mag(5,H2[-1])))
plot1 ,= pl.plot(H1,M1,'k')
plot2 ,= pl.plot(H2,M2,'k.')
pl.xlabel('H')
pl.ylabel('Magnetization')
pl.xlim(-10,10)
pl.ylim(-1.1,1.1)
pl.legend([plot1,plot2],['from negetive','from positive'],loc ="best" )
pl.title('Ising model Monte Carlo,T = 5')
pl.show()
